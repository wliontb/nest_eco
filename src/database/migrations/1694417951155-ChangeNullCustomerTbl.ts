...
export class ChangeNullCustomerTbl1694417951155 implements MigrationInterface {
    name = 'ChangeNullCustomerTbl1694417951155'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`productdetail\` CHANGE \`productId\` \`productId\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`avatar\` \`avatar\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`address2\` \`address2\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`address1\` \`address1\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`lastName\` \`lastName\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` CHANGE \`firstName\` \`firstName\` varchar(255) NOT NULL`);
