...
export class AddIsAdminandTrending1694490974613 implements MigrationInterface {
    name = 'AddIsAdminandTrending1694490974613'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`isAdmin\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`isFlashsale\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`isTrending\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` DROP COLUMN \`isFlashsale\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`isAdmin\``);
    }
