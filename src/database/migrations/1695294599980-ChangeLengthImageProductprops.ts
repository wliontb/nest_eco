...
export class ChangeLengthImageProductprops1695294599980 implements MigrationInterface {
    name = 'ChangeLengthImageProductprops1695294599980'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`productdetail\` ADD \`picture\` varchar(500) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`invoice\` CHANGE \`customerId\` \`customerId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`invoice\` CHANGE \`customerId\` \`customerId\` int NULL DEFAULT 'NULL'`);
