...
export class RemoveRelationGoodcateSupplier1693881056105 implements MigrationInterface {
    name = 'RemoveRelationGoodcateSupplier1693881056105'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`goods_category\` DROP FOREIGN KEY \`FK_f7e43721110769200c794b3c897\``);
        await queryRunner.query(`ALTER TABLE \`goods_category\` DROP COLUMN \`supplierId\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`category\` ADD CONSTRAINT \`FK_d75549613c2ae44496853c6de26\` FOREIGN KEY (\`goodCategoryId\`) REFERENCES \`goods_category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`goods_category\` ADD \`supplierId\` int NULL DEFAULT 'NULL'`);
