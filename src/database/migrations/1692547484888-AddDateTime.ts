...
export class AddDateTime1692547484888 implements MigrationInterface {
    name = 'AddDateTime1692547484888'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`payment\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`payment\` ADD \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`supplier\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`supplier\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`supplier\` ADD \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`goods_category\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`goods_category\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`goods_category\` ADD \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`productdetail\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`productdetail\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`productdetail\` ADD \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`productprop\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`productprop\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`productprop\` ADD \`deletedAt\` datetime(6) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`shipper\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`shipper\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`shipper\` ADD \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`orderdetail\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`orderdetail\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`orderdetail\` ADD \`deletedAt\` datetime(6) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`payment\` ADD CONSTRAINT \`FK_a3772a91be111b4b6a8a496fffa\` FOREIGN KEY (\`supplierId\`) REFERENCES \`supplier\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`orderdetail\` DROP COLUMN \`deletedAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`shipper\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`shipper\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`shipper\` DROP COLUMN \`createdAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`productprop\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`productprop\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`productprop\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`productdetail\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`productdetail\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`productdetail\` DROP COLUMN \`createdAt\``);
        ...
        await queryRunner.query(`ALTER TABLE \`goods_category\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`goods_category\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`goods_category\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`supplier\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`supplier\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`supplier\` DROP COLUMN \`createdAt\``);
