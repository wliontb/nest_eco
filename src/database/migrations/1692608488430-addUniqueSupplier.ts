...
export class AddUniqueSupplier1692608488430 implements MigrationInterface {
    name = 'AddUniqueSupplier1692608488430'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`supplier\` ADD UNIQUE INDEX \`IDX_977003cc69959e72078db19db6\` (\`phone\`)`);
        await queryRunner.query(`ALTER TABLE \`supplier\` ADD UNIQUE INDEX \`IDX_c40cbff7400f06ae1c8d9f4233\` (\`email\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`supplier\` DROP INDEX \`IDX_c40cbff7400f06ae1c8d9f4233\``);
        await queryRunner.query(`ALTER TABLE \`supplier\` DROP INDEX \`IDX_977003cc69959e72078db19db6\``);
